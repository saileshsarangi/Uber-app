...
function ConfirmRidePopup(props) {
    ...
    return (
        <div >
            ...
            <h3 className='text-2xl font-semibold mb-4 '> confirm the ride to start </h3>
            <div className='flex items-center justify-between p-3 bg-gray-400 rounded-lg mt-4 '>
                <div className='flex items-center gap-3'>
                    ...
                    <h5 className='text-xl font-bold'>{props.ride?.user.fullname.firstname}</h5>
                </div>
                <h5>2.2km</h5>
            </div>
            <div className='flex justify-between gap-2 flex-col items-center'>
                ...
                <div className='mt-6 items-center'>
                    <form className='flex flex-col items-center justify-center' onSubmit={(e) => { submitHander(e) }}>
                        <div className="flex justify-center w-full">
                            <input
                                ...
                                type='text'
                                className='bg-[#eeee] px-12 py-2 text-lg rounded-lg mt-3 font-mono'
                        ...
                        <div className='w-screen flex justify-between pl-6 pr-6 mt-4'>
                            <button
                                type="submit"
                                className='m-2 w-1/2 bg-green-800 text-white font-semibold p-2 rounded-lg'
                            ...
                            <button
                                ...
                                className='m-2 w-1/2 bg-red-500 text-white font-semibold p-2 rounded-lg'
                            >
                                Cancel
                            </button>
                        </div>
