...
function CaptainRiding() {
    ...
    if (!showLowerPanel) {
        icon = (<div
            ...
            <i className=" text-gray-700 text-2xl font-semibold  ri-arrow-up-wide-line"></i>
        </div>)
    }
    else {
        icon = (
            <div
                ...
                className=' text-center mb-2'>
                <i className=" text-gray-700 text-2xl font-semibold  ri-arrow-down-wide-line"></i>
            </div>
    ...
    return (
        <div>
            <div className='h-screen'>
                <div className='fixed p-6 top-0 items-center justify-between w-screen'>
                    ...
                    <Link to='/captain-login' className='fixed  right-2 top-2 h-10 w-10 bg-white flex items-center justify-center rounded-full'>
                        <i className=' text-lg text-white font-bold ri-logout-box-r-line'></i>
                    </Link>
                </div>
                <div ref={UpperdivRef} className='h-4/5 '>
                    <div className='h-1/2'>
                        <LiveTracking />
                    </div>
                ...
                <div ref={LowerDivRef}
                    className='h-1/5 pb-6 pl-6 pr-6 item-center justify-between '>
                    {icon}
                    <div className='flex items-center justify-center '>
                        <div className='flex items-center justify-between gap-1 '>
                            <i className=' text-2xl text-gray-700 ri-navigation-fill'></i>
                            <h4 className='text-xl font-semibold '>5 K.M Away</h4>
                        </div>
                    </div>
                    <button
                        onClick={() => {
                            setFinishRidePanel(true)
                        }} className='w-full mt-5   bg-green-800 text-white font-semibold p-2 rounded-lg'>Complete Ride</button>
                    <div ref={lowerPanelRef} className='transition-transform duration-300 p-6 pt-0 mt-4 '>
                        <div className='flex items-center gap-3 mb-2'>
                            ...
                            <h5 className='text-xl font-bold'>{rideData?.user.fullname.firstname}</h5>
                        </div>
            ...
            <div ref={finishRidePanelRef} className='fixed  w-full z-10 bottom-0 p-3 bg-white py-10 px-3  pt-12 h-[70%]'>
                <FinishRide
                    ride={rideData}
