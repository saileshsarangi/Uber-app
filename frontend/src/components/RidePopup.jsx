            ...
            <div className='flex justify-between gap-2 flex-col items-center'>
                ...
                <div className='w-full flex gap-10 '>
                    <button onClick={() => {
                        ...
                        props.setRidePopupPanel(false)
                        console.log(props.ConfirmRidePopupPanel)
                        props.confirmRide()
                    }} className='w-1/2 m-2  bg-green-800 text-white font-semibold p-2 rounded-lg'>Confirm</button>
                    <button onClick={() => {
                        props.setRidePopupPanel(false)
                    }} className='w-1/2 m-2 bg-gray-300 text-white font-semibold p-2 rounded-lg'>Ignore</button>
                </div>
            </div>
        </div>
    )
